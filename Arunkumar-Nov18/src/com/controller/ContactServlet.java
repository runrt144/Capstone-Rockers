...
public class ContactServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String tripoptFlight1= request.getParameter( "tripoptFlight");
		...
		System.out.println("flight : " + tripoptFlight1 +" From : " +tripoptFromTo 
				+" Date : " + flightDate +" Dur : " +flightDur);
		if(flight.equals(null))
			System.out.println("No flight information fetched.");
		else{
			HttpSession session = request.getSession();
			session.setAttribute("flight", flight);
			session.setAttribute("tripoptFlight", tripoptFlight1);
